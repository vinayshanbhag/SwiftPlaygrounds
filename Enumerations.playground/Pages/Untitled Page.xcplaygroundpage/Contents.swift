...
// Enumerations can only have computed instance properties. No stored instance properties
// Enumerations can have both stored and computed type (static) properties
// Enumerations cannot inherit from other enumerations
// Enumerations can implement protocols
// Enumerations can be recursive (indirect keyword)
